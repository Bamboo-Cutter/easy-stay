        ...
        AuthService_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.prisma.users.findUnique({ where: { email: dto.email } })];
                        case 1:
                            exists = _b.sent();
                            if (exists)
                                throw new common_1.BadRequestException('邮箱已注册');
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.prisma.users.create({
                                    data: {
                                        email: dto.email,
                                        password: hash,
                                        role: (_a = dto.role) !== null && _a !== void 0 ? _a : client_1.user_role.MERCHANT,
                                    },
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            token = _a.sent();
                            return [2 /*return*/, { access_token: token, user: { id: user.id, email: user.email, role: user.role } }];
                    }
                });
            });
        };
