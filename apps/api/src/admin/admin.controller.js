...
var AdminController = function () {
    var _classDecorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.user_role.ADMIN), (0, common_1.Controller)('admin')];
    ...
    var AdminController = _classThis = /** @class */ (function () {
        ...
        AdminController_1.prototype.pending = function () {
            return this.admin.pendingHotels();
        };
        AdminController_1.prototype.approve = function (id) {
            return this.admin.approve(id);
        };
        AdminController_1.prototype.reject = function (id, body) {
            var _a;
            return this.admin.reject(id, (_a = body === null || body === void 0 ? void 0 : body.reason) !== null && _a !== void 0 ? _a : 'rejected');
        };
    ...
    (function () {
        ...
        _pending_decorators = [(0, common_1.Get)('hotels/pending')];
        _approve_decorators = [(0, common_1.Post)('hotels/:id/approve')];
        _reject_decorators = [(0, common_1.Post)('hotels/:id/reject')];
